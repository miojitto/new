...
if (isset($_SESSION['id_funcionario']) && $_SESSION['id_funcionario'] != "") {
    if (isset($_SESSION['id_funcionario']) && $_SESSION['id_cargo'] == 1) {
      ...
      echo ("<script>alert('Você logou como: Médico');</script>");
    }elseif (isset($_SESSION['id_funcionario']) && $_SESSION['id_cargo'] == 3) {
      echo ("<script>alert('Você logou como: Enfermeiro');</script>");
    }elseif (isset($_SESSION['id_funcionario']) && $_SESSION['id_cargo'] == 4) {
      echo ("<script>alert('Você logou como: Farmacêutico');</script>");
    }
}elseif (isset($_SESSION['usuario_session']) == "erro" && $_SESSION['senha_session'] == "erro" && $_SESSION['id_funcionario'] == ""){
          ...
          <h1 class="mt-4 mb-4">Login</h1>
           <!--<form action="login.php">
			...
			<form action="confirm_login.php" method="POST" name="form_login">	
				<div class="form-group front">
				<input type="text" placeholder="usurio" required name="login">
				</div>
				<div class="form-group front">
